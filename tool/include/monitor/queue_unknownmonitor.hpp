#ifndef Queue_UNKNWON_MONITOR_H
#define Queue_UNKNOWN_MONITOR_H
...
class QueueUnknownMonitor : public Monitor
{
protected:
	...
	std::vector<std::queue<QueueOp>> pendingDeqs;
	std::vector<QueueOp> pendingEnqs;
	std::map<val_t, QueueOp> crashedEnqs;
...
public:
	...
	QueueUnknownMonitor(MonitorConfig mc);
